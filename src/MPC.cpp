...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    /*
     * MPC implementation adapted from in class quiz.
     *
     * `fg` a vector of the cost constraints, `vars` is a vector of variable
     * values (state & actuators).
     *
     * Coefficients 2000,200,10,5 control how much attention you want the
     * cost function to pay to certain attributes.
     */
    fg[0] = 0;
